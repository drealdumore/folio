          ...
          <div className="flex flex-col lg:h-2/6 h-2/5 max-lg:w-full max-lg:flex">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mb-4 text-text-normal" role="text">
                ...
                . I blend design sense with solid engineering to build fast,
                friendly apps on web and mobile. I work with modern JavaScript
                tools, and I’m always exploring new ideas, especially around AI
                and machine learning. I love learning,
